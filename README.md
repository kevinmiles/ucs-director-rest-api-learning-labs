...
You can write Markdown in a plain text editor, and desktop and Web-based options allow you to simultaniously write and preview. We recommend Visual Studio Code [Download](https://code.visualstudio.com/) for these reasons:
